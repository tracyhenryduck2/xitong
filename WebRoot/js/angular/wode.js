...
function LoadData(){
    request.post('http://localhost:8080/auto/Member!jsonlist.action?page.pageSize=2').success(function(data){
...
function LoadDataPage(pageNo){
    request.post('http://localhost:8080/auto/Member!jsonlist.action?page.pageSize=2&page.pageNo='+pageNo).success(function(data){
