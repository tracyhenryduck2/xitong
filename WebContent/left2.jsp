...
$(function(){
s_getDate();
var testMenu=${session.menu};
console.log(testMenu);

//var testMenu = [{name:"dsadsa",submenu:[{name:"123"}]},{name:"dsadsa",submenu:[{name:"123"}]},{name:"dsadsa",submenu:[{name:"123"}]}];
new AccordionMenu({menuArrs:testMenu});
 ...
 <body>
	...
	$(function(){
		$.ajax({
		type:"post",
		url:"<%=path%>/system/FunctionGroup!getMenuList.action",
		data:"",
		dataType: 'json',
