...
String parentDirName = request.getParameter("dirName");
if(parentDirName==null || parentDirName.equals("")) {
	parentDirName = "uploadImages";
}

File tmpFile = new File(request.getSession().getServletContext().getRealPath(""));

String savePath = tmpFile.getParentFile().getAbsolutePath()+"/huahuo_images/" + parentDirName+"/";
String subPath = "/huahuo_images/" + parentDirName+"/";
//文件保存目录URL /zswz/attached/
String saveUrl = tmpFile.getParentFile().getAbsolutePath() + "/huahuo_images//"+parentDirName+"/";
...
//
out.println("{\"error\":0,\"url\":\""+subPath +"/" + newImgName+"\"}");
%>
<%!
