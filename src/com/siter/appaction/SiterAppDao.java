...
public class SiterAppDao extends BaseDAO{
	...
	public Map<String,Object> getAppUpdate(String project){
		
		String sql = "select * from app_update  where ios != 1 and project='"+project+"' limit 1";
	...
	public Map<String,Object> getAppUpdateIos(String project){
